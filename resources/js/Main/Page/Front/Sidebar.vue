      ...
      <li v-for="cat in parentcats" :key="cat.id" class="side-nav-item">
        ...
        <span class="d-flex justify-content-between align-items-center">
          ...
          <span v-if="cat.parents.length != 0">
            <i v-if="child == cat.id" class="fa fa-chevron-down text-secondary" v-on:click="showChild(cat.id)"></i>
            <i v-else class="fa fa-chevron-right text-secondary" v-on:click="showChild(cat.id)"></i>
          </span>
        </span>
          ...
          <li v-for="catchild in cat.parents" :key="catchild.id" class="side-nav-item-child">
            ...
            <span class="d-flex justify-content-between align-items-center">
              ...
              <span v-if="catchild.parents.length != 0">
                <i v-if="gchild == catchild.id" class="fa fa-chevron-down text-secondary" v-on:click="showGChild(catchild.id)"></i>
                <i v-else class="fa fa-chevron-right text-secondary" v-on:click="showGChild(catchild.id)"></i>
              </span>
            </span>
